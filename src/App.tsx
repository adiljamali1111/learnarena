    ...
    return (
      <div className="flex flex-col items-center justify-center flex-1 px-4 text-center">
        ...
        <p className="text-text-muted max-w-md">
          Drop your study materials here to get started. Upload PDFs, DOCX files, images with text, or paste your notes.
        </p>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {modules.map((mod) => (
            <button
              ...
              className="text-left bg-bg-card hover:bg-bg-hover border border-border rounded-xl p-4 transition-all duration-200 cursor-pointer group"
            >
